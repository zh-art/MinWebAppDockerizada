...
Vagrant.configure("2") do |config|
  # Definir la máquina virtual como 'ParcialFinal'
  config.vm.define :ParcialFinal do |servidor|
    servidor.vm.box = "bento/ubuntu-22.04"
    servidor.vm.network :private_network, ip: "192.168.50.4"
    servidor.vm.hostname = "ParcialFinal" 
    ...
    servidor.vm.provision "shell", inline: <<-SHELL
      ...
      # Crear usuarios para Prometheus y Node Exporter
